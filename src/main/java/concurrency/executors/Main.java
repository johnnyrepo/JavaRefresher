...
/**
 * It's always better to use a Thread Executor Service in favor of manual thread creation, monitor locks control, etc.
 */
public class Main {
    ...
    public static void cachedExecutorMain(String[] args) {
        var multiExecutor = Executors.newCachedThreadPool();
        try {
    ...
    public static void multiExecutorServiceMain(String[] args) {
        int count = 3;
    ...
    public static void singleExecutorServiceMain(String[] args) {
    ...
    public static void manualThreadMain(String[] args) {
    ...
    private static void countDown() {
        ...
        try {
            ...
            // If user passes bad color name, just ignoring it
        }
